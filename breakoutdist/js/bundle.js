...
module.exports = __webpack_require__(/*! C:\Labo\breakout\src\main.js */335);
...
var _MainMenu = __webpack_require__(/*! ./states/MainMenu */ 353);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function initGlobalVariables() {
      this.game.global = _lodash2.default.clone(_index2.default);
    }
  }, {
    key: 'preload',
...
var _lang = __webpack_require__(/*! ../lang */ 345);

var _lang2 = _interopRequireDefault(_lang);

var _Brick = __webpack_require__(/*! ../prefabs/Brick */ 347);

var _Brick2 = _interopRequireDefault(_Brick);

var _Paddle = __webpack_require__(/*! ../prefabs/Paddle */ 348);

var _Paddle2 = _interopRequireDefault(_Paddle);

var _Ball = __webpack_require__(/*! ../prefabs/Ball */ 349);

var _Ball2 = _interopRequireDefault(_Ball);

var _Bonus = __webpack_require__(/*! ../prefabs/Bonus */ 350);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function releaseBall() {
      ...
      this.balls.getFirstAlive().body.velocity.y = -330;
      this.balls.getFirstAlive().body.velocity.x = -40;
    }
  }, {
    key: 'setUpBall',
    value: function setUpBall() {
      this.ball = new _Ball2.default(this.game, this.game.world.centerX, this.game.world.height - 100);
    ...
    key: 'setUpFirstBall',
    value: function setUpFirstBall() {
      this.addBall(this.game.world.centerX, this.game.world.height - 100);
      this.putBallOnPaddle();
    }
  }, {
    key: 'setUpBalls',
    value: function setUpBalls() {
      this.balls = this.game.add.group();
      this.setUpFirstBall();
    }
  }, {
    key: 'ballLost',
    value: function ballLost(ball) {
    ...
    key: 'setUpBonus',
    value: function setUpBonus() {
      this.bonus = this.game.add.group();
    }
  }, {
    key: 'setUpExtraBalls',
    value: function setUpExtraBalls() {
    ...
    value: function generateBricks(bricksGroup) {
      var rows = this.game.global.defaultRows + this.game.global.level;
      var columns = this.game.global.defaultColumns + this.game.global.level;
      var xOffset = 40;
      var yOffset = 25;
      var brick = void 0;
      var marginTop = 80 - 10 * this.game.global.level;
        ...
        for (var x = 0; x < columns; x++) {
          ...
          if (this.game.global.level > 2) {
            for (var i = 0; i < this.game.global.level; i++) {
              if (Math.random() > 0.9) level++;
            }
          }

          brick = new _Brick2.default(this.game, x * xOffset, y * yOffset + marginTop, level);
      ...
      bricksGroup.position.setTo(this.game.world.centerX - bricksGroupWidth, this.game.world.centerY - 200);
    }
  }, {
    key: 'setUpText',
    ...
    key: 'createText',
    value: function createText(xOffest, yOffest, text, style) {
      var textDone = this.game.add.text(xOffest, yOffest, text, style);
    ...
    value: function update() {
      ...
      this.game.physics.arcade.collide(this.balls, this.paddle, this.ballHitPaddle, function (ball, paddle) {
        this.oldPaddle = paddle;return true;
      }, this);

      //Collision between balls and bricks
      this.game.physics.arcade.collide(this.balls, this.bricks, this.ballHitBrick, function (ball, brick) {
        if (ball.isFireBall) {
      ...
      this.game.physics.arcade.collide(this.bonus, this.paddle, this.bonusWon, null, this);

      //Collision between bonus and other components
      this.game.physics.arcade.collide(this.bonus, [this.bricks, this.balls], null, function () {
        return false;
      }, this);
    }
    ...
    key: 'bonusHitWorld',
    value: function bonusHitWorld(bonus) {
      bonus.kill();
    }
  }, {
    key: 'getBonus',
    value: function getBonus(brick) {
    ...
    key: 'setBonus',
    value: function setBonus(type, x, y) {
      var bonus = new _Bonus2.default(this.game, x, y, type);
    ...
    key: 'bonusLost',
    value: function bonusLost(bonus) {
      bonus.kill();
    }
  }, {
    key: 'chooseBonus',
    value: function chooseBonus() {
      var rdm = Math.floor(Math.random() * 100 + 1);
      if (rdm < 5) return 'bonusLife';
      if (rdm < 10) return 'bonusMaxPaddle';
      if (rdm < 15) return 'bonusExtraBalls';
      if (rdm < 20) return 'bonusFireBall';
      return null;
    }
  }, {
    key: 'bonusWon',
    value: function bonusWon(paddle, bonus) {
      switch (bonus.name) {
        case 'bonusLife':
        ...
        case 'bonusMaxPaddle':
          ...
          this.game.time.events.add(_phaser2.default.Timer.SECOND * 10, function () {
            this.paddle.width -= 50;
          }, this);
          break;
        case 'bonusExtraBalls':
          for (var i = 0; i < 3; i++) {
            this.addBall(this.game.world.centerX, this.game.world.height - 400, Math.floor(Math.random() * 200 + 20) * -1, Math.floor(Math.random() * 400 + 20) * -1);
          }
          break;
        case 'bonusFireBall':
    ...
    key: 'displayBonusWon',
    value: function displayBonusWon(bonusName) {
      var text = void 0;
      switch (bonusName) {
        case 'bonusLife':
          text = "+1 vie";
    ...
    key: 'setFlashBag',
    value: function setFlashBag(msg) {
      var text = this.createText(0, 250, msg, { font: '24px Arial', fill: '#000', boundsAlignH: 'center' });
      this.game.time.events.add(_phaser2.default.Timer.SECOND * 2, function () {
        this.game.add.tween(text).to({ alpha: 0 }, 500, _phaser2.default.Easing.Linear.None, true);
      }, this);
    }
  }, {
    key: 'addBall',
    value: function addBall(x, y, velX, velY, isFireBall) {
      if (!x) x = this.game.world.centerX;
      if (!y) x = this.game.world.height - 300;
      if (!velX) velX = 0;
      if (!velY) velY = 0;
      if (!isFireBall) isFireBall = false;
      var extraBall = new _Ball2.default(this.game, x, y, isFireBall);
    ...
    key: 'convertToFireBalls',
    value: function convertToFireBalls() {
      this.balls.forEachAlive(function (elm) {
        elm.isFireBall = true;
    ...
    key: 'breakBrick',
    value: function breakBrick(brick) {
      if (brick.level != 1) {
        --brick.level;
...
var _idiom = __webpack_require__(/*! idiom.js */ 346);
...
var Brick = function (_Phaser$Sprite) {
  ...
  function Brick(game, x, y, level) {
    _classCallCheck(this, Brick);

    var nameSprite = 'brick' + level;

    var _this = _possibleConstructorReturn(this, (Brick.__proto__ || Object.getPrototypeOf(Brick)).call(this, game, x, y, nameSprite));
...
var Ball = function (_Phaser$Sprite) {
    ...
    function Ball(game, x, y, isFireBall) {
        _classCallCheck(this, Ball);

        var spriteImg = isFireBall ? 'fireBall' : 'ball';

        var _this = _possibleConstructorReturn(this, (Ball.__proto__ || Object.getPrototypeOf(Ball)).call(this, game, x, y, spriteImg));
...
var Bonus = function (_Phaser$Sprite) {
  _inherits(Bonus, _Phaser$Sprite);

  function Bonus(game, x, y, type) {
    _classCallCheck(this, Bonus);

    var _this = _possibleConstructorReturn(this, (Bonus.__proto__ || Object.getPrototypeOf(Bonus)).call(this, game, x, y, type));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'create',
    value: function create() {
      var text = this.add.text(this.game.width * 0.5, this.game.height * 0.5, 'Game Over\n\n You reached ' + this.game.global.level + ' level with score ' + this.game.global.score, {
        font: '24px Arial',
        fill: '#000',
        align: 'center'
      });
...
var LabelButton = function LabelButton(game, x, y, key, label, callback, callbackContext, overFrame, outFrame, downFrame, upFrame) {
  _phaser2.default.Button.call(this, game, x, y, key, callback, callbackContext, overFrame, outFrame, downFrame, upFrame);
  //Style how you wish...
  this.style = {
    'font': '220px Arial',
    'fill': 'white'
  ...
  this.label = new _phaser2.default.Text(game, 0, 0, label, this.style);
...
LabelButton.prototype = Object.create(_phaser2.default.Button.prototype);LabelButton.prototype.constructor = LabelButton;LabelButton.prototype.setLabel = function (label) {
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'create',
    value: function create() {
      var defaultHeightbutton = 85;
      var defaultWidthButton = 200;
      var startButton = new LabelButton(this.game, this.game.world.centerX - defaultWidthButton / 2, this.game.world.centerY - defaultHeightbutton / 2, 'button', 'Play', this.start, this, 2, 1, 0);
